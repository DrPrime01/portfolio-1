      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
          ...
          <div className="flex justify-between items-center mt-7">
            <button type="button" className="arrow-btn" onClick={() => handleNavigation('prev')}>
              <img src="/assets/left-arrow.png" alt="prev arrow" className="size-4" />
            </button>
            <button type="button" className="arrow-btn" onClick={() => handleNavigation('next')}>
              <img src="/assets/right-arrow.png" alt="next arrow" className="size-4" />
            </button>
          </div>
        </div>
